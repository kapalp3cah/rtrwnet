"""
Django settings for rtrwnet project.
...
SECRET_KEY = 'django-insecure-p2ed0ccnaq22g7e5w198vn^d@l*(s@7&dhjlm-y5!z7jphkd&-'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = [
    'kapalp3cah.pythonanywhere.com',
...
WSGI_APPLICATION = 'rtrwnet.wsgi.application'
...
STORAGES = {
    ...
    "staticfiles": {
        "BACKEND": "whitenoise.storage.CompressedManifestStaticFilesStorage",  # Untuk production [citation:3]
    },
}
